...
const MyJobs = () => {
  const email = "hamza.dev011@gmail.com";
  ...
  useEffect(() => {
    setIsLoading(true);
    fetch(`http://localhost:5000/myJobs/anas@gmail.com`)
      .then((res) => res.json())
      .then((data) => {
        setJobs(data);
      });
  ...
  const handleSearch = () => {
    const filteredJobs = jobs.filter((job) => {
      const title = job.jobTitle ? job.jobTitle.toLowerCase() : ""; // Check if job.jobTitle is defined
      ...
      <div className="my-jobs-container">
        ...
        <div className="search-box p-2 text-center mb-2">
          <input
            ...
            name="search"
            id="search"
            className="py-2 pl-3 border focus: outline-none lg: w-6/12 mb-4w-full"
          />
          <button
